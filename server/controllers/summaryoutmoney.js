...
exports.getDocByDayOutMoney = async(req, res) => {
    var start = new Date();
...
exports.getDocByMonthOutMoney = async(req, res) => {
    var start = new Date();
...
exports.getDocByYearOutMoney = async(req, res) => {
    var start = new Date();
    start.setMonth(0)
...
exports.getDocByWeekOutMoney = async(req, res) => {
  var start = new Date();
