...
exports.getDocByDayInPerson = async(req, res) => {
    var start = new Date();
...
exports.getDocByMonthInPerson = async(req, res) => {
    var start = new Date();
...
exports.getDocByYearInPerson = async(req, res) => {
    var start = new Date();
    start.setMonth(0)
...
exports.getDocByWeekInPerson = async(req, res) => {
  var start = new Date();
