...
exports.getDocByDayInMoney = async(req, res) => {
    var start = new Date();
...
exports.getDocByMonthInMoney = async(req, res) => {
    var start = new Date();
...
exports.getDocByYearInMoney = async(req, res) => {
    var start = new Date();
    start.setMonth(0)
...
exports.getDocByWeekInMoney = async(req, res) => {
  var start = new Date();
