...
exports.getDocByDayInRes = async(req, res) => {
    var start = new Date();
...
exports.getDocByMonthInRes = async(req, res) => {
    var start = new Date();
...
exports.getDocByYearInRes = async(req, res) => {
    var start = new Date();
    start.setMonth(0)
...
exports.getDocByWeekInRes = async(req, res) => {
  var start = new Date();
