...
exports.getDocByDayInObj = async(req, res) => {
    var start = new Date();
...
exports.getDocByMonthInObj = async(req, res) => {
    var start = new Date();
...
exports.getDocByYearInObj = async(req, res) => {
    var start = new Date();
    start.setMonth(0)
...
exports.getDocByWeekInObj = async(req, res) => {
  var start = new Date();
