...
exports.getDocByDayInEdu = async(req, res) => {
    var start = new Date();
...
exports.getDocByMonthInEdu = async(req, res) => {
    var start = new Date();
...
exports.getDocByYearInEdu = async(req, res) => {
    var start = new Date();
    start.setMonth(0)
...
exports.getDocByWeekInEdu = async(req, res) => {
  var start = new Date();
