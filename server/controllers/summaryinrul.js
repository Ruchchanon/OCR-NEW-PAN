...
exports.getDocByDayInRul = async(req, res) => {
    var start = new Date();
...
exports.getDocByMonthInRul = async(req, res) => {
    var start = new Date();
...
exports.getDocByYearInRul = async(req, res) => {
    var start = new Date();
    start.setMonth(0)
...
exports.getDocByWeekInRul = async(req, res) => {
  var start = new Date();
